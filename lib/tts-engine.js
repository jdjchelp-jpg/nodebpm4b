...
const { getPool } = require('./tts-pool');

let modelInstance = null;
const MAX_CHUNK_LENGTH = 5000; // Reverted back to 5000 characters per chunk
 ...
 */
async function generateChapterAudio(chapterText, outputDir, config, onProgress = null, jobId = null) {
